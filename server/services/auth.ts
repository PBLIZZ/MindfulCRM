...
// Google profile interface based on passport-google-oauth20 profile structure
...
const CALLBACK_URL =
  ...
  `${process.env.REPLIT_DOMAINS?.split(',')[0] ?? 'http://localhost:8080'}/auth/google/callback`;
