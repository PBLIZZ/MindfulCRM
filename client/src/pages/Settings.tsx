...
export default function Settings() {
  ...
  const handleProcessEvents = async () => {
    ...
    try {
      ...
      // Error logging removed per DATA_DOCTRINE - no console statements in production
  ...
  const handleGdprConsentChange = async (checked: boolean) => {
    ...
    try {
      ...
      if (checked) {
        alert(
          'GDPR consent granted. You can now send consent forms to clients and begin profile picture enrichment.'
        );
      } else {
      ...
      <div className='grid gap-6'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sync and process your Google Calendar events with AI-powered filtering and
              deduplication.
            </CardDescription>
          </CardHeader>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div className='space-y-2'>
                  ...
                  <Select
                    value={syncMonths.toString()}
                    onValueChange={(value) => setSyncMonths(parseInt(value))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div className='flex justify-end'>
                ...
                >
                  ...
                  {isHistoricalSyncLoading
                    ? 'Syncing...'
                    : `Sync ${syncMonths} Month${syncMonths !== 1 ? 's' : ''}`}
                </Button>
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage your privacy settings and consent for data processing.
            </CardDescription>
          </CardHeader>
          <CardContent className='space-y-4'>
            <div className='space-y-4'>
              <div className='flex items-start space-x-3'>
                ...
                <div className='space-y-1 leading-none'>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    I consent to the collection of public profile pictures from social media
                    platforms (LinkedIn, Facebook, X, Instagram, GitHub) for client contact
                    enhancement. This enables sending GDPR consent forms to clients and enriching
                    their profiles with public images.
                  </p>
                </div>
              </div>
              ...
              {allowProfilePictureScraping && (
                <div className='ml-6 p-4 bg-green-50 border border-green-200 rounded-lg'>
                  ...
                  <p className='text-sm text-green-600 mb-3'>
                    You have enabled profile picture scraping. You can now send consent forms to
                    clients and begin enriching their contact records with public social media
                    profile pictures.
                  </p>
              ...
              {!allowProfilePictureScraping && (
                <div className='ml-6 p-4 bg-amber-50 border border-amber-200 rounded-lg'>
                  ...
                  <p className='text-sm text-amber-600'>
                    To enable profile picture scraping for client contacts, you must first consent
                    to the data processing. This will allow you to:
                  </p>
            ...
            <div className='flex items-center justify-between'>
              ...
              <Button onClick={openConsentForm} variant='outline' size='sm'>
                <ExternalLink className='h-4 w-4 mr-2' />
                View Form
              </Button>
            </div>
